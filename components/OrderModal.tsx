...
import { X, CheckCircle, DollarSign, User, MapPin, Phone, Settings, AlertCircle } from 'lucide-react';
...
export const OrderModal: React.FC<OrderModalProps> = ({ isOpen, product, editingOrder, onClose, onConfirm }) => {
  ...
  // Determine the target product data
  ...
  // Reset or Populate form when product/editingOrder changes
  useEffect(() => {
    if (isOpen) {
      if (editingOrder) {
  ...
  // Usando a função utilitária centralizada

...
export const SOBREMESAS: Product[] = [
    { id: 's1', nome: "Brownie", preco: 12, categoria: 'sobremesa', img: "https://picsum.photos/seed/s1/400/300", ingredientes: [] },
    { id: 's2', nome: "Sorvete", preco: 10, categoria: 'sobremesa', img: "https://picsum.photos/seed/s2/400/300", ingredientes: [] },
    { id: 's3', nome: "Pudim", preco: 8, categoria: 'sobremesa', img: "https://picsum.photos/seed/s3/400/300", ingredientes: [] },
    { id: 's4', nome: "Bolo de Chocolate", preco: 9, categoria: 'sobremesa', img: "https://picsum.photos/seed/s4/400/300", ingredientes: [] },
    { id: 's7', nome: "Brigadeiro", preco: 4, categoria: 'sobremesa', img: "https://picsum.photos/seed/s7/400/300", ingredientes: [] },
];
